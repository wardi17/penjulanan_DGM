...
foreach ($data as $datas){
  $fulldata [] = [
   ...
   'maxweek1'=>number_format(getmaxt($connection,$tahunpage,$datas['nama_toko'],"w1"),2),
	'maxweek2'=>number_format(getmaxt($connection,$tahunpage,$datas['nama_toko'],"w2"),2),
    'maxweek3'=>number_format(getmaxt($connection,$tahunpage,$datas['nama_toko'],"w3"),2),
    'maxweek4'=>number_format(getmaxt($connection,$tahunpage,$datas['nama_toko'],"w4"),2),
  ];
}
...
// function get_l0($conn,$tahunpage,$bulan,$nama_toko){
//     $lo = '';
//     if($bulan == "January"){
//       $lo =37;
//     }else{
