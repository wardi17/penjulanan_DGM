      ...
      <div class="modal-content">
        ...
        <form  id ="formtambah"  class ="form form-horizontal">
                    ...
                    <div class="row col-md-12 mb-3">  
                        ...
                        <div class="row col-md-12 mb-3"> 
                                ...
                                <div class ="col-md-6">
                                  <?php  for($i=1; $i <=4; $i++ ):?>
                                    ...
                                    <input class="form-check-input checkweek" type="checkbox" id="w<?=$i?>" name="week" value="w<?=$i?>" >
                        ...
                        <div class =" row col-md-12 mb-3">
                            <label for="tgl_week_awal" class="col-sm-2 col-form-label" >Tgl Awal</label>
                                <div class = "col-md-2">
                                <select type="text" id="tgl_week_awal" class="form-control"></select>
                                </div>
                                <label for="tgl_week_akhir" class="col-sm-2 col-form-label">Tgl Akhir</label>
                                <div class ="col-md-2">
                                    <select type="text" id="tgl_week_akhir" class="form-control"></select>
                                </div>
...
$(document).ready(function(){
  ...
  $("#Createdata").on('click',function(e){
    ...
    let wilayah = $("input[type=checkbox][name=week]:checked").val();
    let tgl_awal = $("#tgl_week_awal").find(":selected").val();
    let tgl_akhir = $("#tgl_week_akhir").find(":selected").val();

    $.ajax({
      url:'models/master_bulanWeek/tambahdata.php',
      method:'POST',
...
function get_tanggal(){
  var tgl_awal = $("#tgl_week_awal");
    var tgl_akhir = $("#tgl_week_akhir");
